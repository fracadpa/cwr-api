...
// @ts-expect-error issue with path
import type { Company } from '../../../../companies/domain/companies';
...
export class UserMapper {
  static toDomain(raw: UserSchemaClass): User {
    ...
    if (raw.company) {
      domainEntity.company = { id: raw.company } as Company;
    }
  ...
  static toPersistence(domainEntity: User): UserSchemaClass {
    ...
    if (domainEntity.company) {
      persistenceSchema.company = domainEntity.company.id;
    }
